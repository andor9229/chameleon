...
(function() {
  ...
  MT("supports",
   ...
   MT("document",
      "[def @model] [variable&callee url]([string http://blah]),",
   ...
   MT("document_url",
      "[def @model] [variable&callee url]([string http://blah]) { [qualifier .class] { } }");

   MT("document_urlPrefix",
      "[def @model] [variable&callee url-prefix]([string https://]) { [builtin #id] { } }");

   MT("document_domain",
      "[def @model] [variable&callee domain]([string blah.com]) { [tag foo] { } }");

   MT("document_regexp",
      "[def @model] [variable&callee regexp]([string \".*blah.+\"]) { [builtin #id] { } }");
